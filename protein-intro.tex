...
\fixme{Might replace this chapter if the paper itself changes before
  publishing (which it will) but put it in now to see how long the
  dissertation is at this point.  In reading this, I'd skip the
  protein section for now, since I'm just going to redo it once we
  have the final paper version of the project}
