\label{chapter:intro}
\fixme{the function we create is a functional, not a function}
...
another derivation to get to the same place introduced
by \fixme{tarazona?}  in \fixme{year} that is thought by some to be
more elegant.  However I don't use any ideas that are directly pulled
from these derivations in my work, besides those that can be taken
from the general characteristics (spherical nature) of the resulting
