...
cavity correlation function for hard spheres, and is required for the
association term in the SAFT free energy, and as well for a term
labeled the 'chain' term, which is used in some SAFT free energy
functionals.
